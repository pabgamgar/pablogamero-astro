		...
		<>
			<div className="fixed left-1/2 top-[80px] z-10 flex -translate-x-1/2 -translate-y-1/2 gap-2 rounded-md bg-[var(--content)] p-2 text-[var(--content-foreground)] backdrop-blur-[30px] w-[90%] sm:w-fit max-w-fit overflow-auto">
				<button
					...
					className={`rounded-md px-2 py-0.5 transition-all duration-500 ${tab === "Favourites" ? "bg-sky-400 text-black" : "hover:bg-gray-600"}`}
				>
				...
				<button
					...
					className={`rounded-md px-2 py-0.5 transition-all duration-500 ${tab === "All" ? "bg-sky-400 text-black" : "hover:bg-gray-600"}`}
				>
					{lang === "en" ? "All" : "Todo"}
				</button>
				<button
					...
					className={`rounded-md px-2 py-0.5 transition-all duration-500 ${tab === "Products" ? "bg-sky-400 text-black" : "hover:bg-gray-600"}`}
				>
				...
				<button
					...
					className={`rounded-md px-2 py-0.5 transition-all duration-500 ${tab === "Businesses" ? "bg-sky-400 text-black" : "hover:bg-gray-600"}`}
				>
